...
ADD CONSTRAINT FACT_FK_IdRep FOREIGN KEY(IdReparacion )REFERENCES repaciones(IdReparacion)
ON DELETE RESTRICT ON UPDATE CASCADE;
...
ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT Inter_FK_IdRep FOREIGN KEY(IdReparacion) REFERENCES repaciones(IdReparacion)
ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE incluyen
ADD CONSTRAINT Incluy_FK_IdRec FOREIGN KEY(IdRecambio) REFERENCES recambios(IdRecambio)
ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT Incluy_FK_IdRep FOREIGN KEY(IdReparacion) REFERENCES repaciones(IdReparacion)
ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE realizan
ADD CONSTRAINT Real_FK_IdRep FOREIGN KEY(IdReparacion) REFERENCES repaciones(IdReparacion)
ON DELETE CASCADE ON UPDATE CASCADE,
